...
export default function Home() {
 ...
 <div className="pulse"></div>
  ...
  <p className="subtitle">Roomify is an AI-first design, that helps you visualize, render, and ship
    architectural projects faster than ever before.</p>
      ...
      <section className="projects">
        <div className="section-inner">
          <div className="section-head">
            <div className="copy">
              <h2>Projects</h2>
              <p>Your latest work and share community projects,
                all in one place.</p>
            </div>
          </div>
